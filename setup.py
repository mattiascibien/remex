...
build_exe_options = {"packages": ["tkinter", "PIL","argparse"], "compressed":"True", "icon": "NuvolaTileIcon.ico", "include_files":[("NuvolaTileIcon.ico","NuvolaTileIcon.ico"), ("automappingRegions.png", "automappingRegions.png")]}
